...
#特别需要的路径
SPECIAL_FILE = ['D:\\svn\\workspace', "D:\\workTools" , "D:\\Datas" , u'D:\\datas\\7、小工具\\dataParse.py'.encode('gbk'),u'D:\\datas\\7、小工具\\protoTools.py'.encode('gbk')]
#置顶的文件
...
class Tools(Frame):
	def __init__(self,findDir,findFiles):
		Frame.__init__(self)
		self.pack()
		self.winfo_toplevel().title("快捷启动工具")
